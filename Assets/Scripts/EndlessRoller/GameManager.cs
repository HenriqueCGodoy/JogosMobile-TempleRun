...
public class GameManager : MonoBehaviour
{
    ...
    {
        //Now we need to get all of the possible places to spawn te obstacle
        var obstacleSpawnPoints = new List<GameObject>();

        //Go through each of the children in our tile
        ...
        {
            //Get random spawn point from the ones we have
